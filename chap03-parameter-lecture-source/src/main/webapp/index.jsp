...
<h4>a태그의 href 속성에 파라미터를 쿼리스트링형태로 작성하여 get 방식 요청</h4>
<a href="http://localhost:8080/querystring?name=%EC%9D%B4%EB%AF%B8%EC%A7%80&age=19&birthday=2004-10-10&gender=F&national=ko&hobbies=music&hobbies=sleep">
        쿼리스트링 이용한 값 전달
</a>
